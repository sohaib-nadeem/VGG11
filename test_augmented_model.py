...
_, test_accuracies = inference(device, './augmented_model', testloaderNormal,
...
_, test_accuracies = inference(device, './augmented_model', testloaderHorizontalFlip,
                               training_epochs, criterion)
...
_, test_accuracies = inference(device, './augmented_model', testloaderVerticalFlip,
                               training_epochs, criterion)
...
plt.savefig('test_accuracy_vs_flip_type_data_augmentation.png')
plt.clf()
...
_, test_accuracies = inference(device, './augmented_model', testloaderGaussianNoise1,
                               training_epochs, criterion)
...
_, test_accuracies = inference(device, './augmented_model', testloaderGaussianNoise2,
                               training_epochs, criterion)
...
_, test_accuracies = inference(device, './augmented_model', testloaderGaussianNoise3,
                               training_epochs, criterion)
...
plt.ylabel('Test Accuracy')
plt.savefig('test_accuracy_vs_gaussian_noise_data_augmentation.png')
plt.clf()
